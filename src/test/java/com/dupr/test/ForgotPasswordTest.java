...
public class ForgotPasswordTest extends DUPRBaseAutomationTest {
	...
	public void verifyForgotPasswordLinkFunctionality() {
		...
		Assert.assertEquals(forgotPasswordValidationText, expectedAssertionsProp.getProperty("forgot.password.text"));
	...
	public void verifySendEmailWithInvalidEmailID() {
		...
		forgotPasswordPage.setEmail(testDataProp.getProperty("invalid.email.in.signup"));
		forgotPasswordPage.clickOnSendEmailButton();
	...
	public void verifySendEmailWithEmptyEmail() {
		logger.info("Starting of verifySendEmailWithEmptyEmail method");
		...
		logger.info("Ending of verifySendEmailWithEmptyEmail method");
	}
	...
	public void verifySendEmailWithNotRegisteredEmailInDupr() {
		logger.info("Starting of verifySendEmailWithNotRegisteredEmailInDupr method");
