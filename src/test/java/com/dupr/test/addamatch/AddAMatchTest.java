...
public class AddAMatchTest extends CommonBaseTest {
	...
	@Test(priority = 4, description = "Verify  search player by invalid name", groups = "sanity")
	@Description("Test case #4, Verify search player by invalid name")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #4, Verify  search player by invalid name")
	public void verifySearchPlayerByInvalidName() {
		logger.info("Starting of verifySearchPlayerByInvalidName method");
	...
	@Test(priority = 5, description = "Verify Add Your Opponent Functionality In Team 2 by Invite a Player", groups = "sanity")
	@Description("Test case #5,Verify Add Your Opponent Functionality In Team 2 by Invite a Player through invite feature ")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #5, Verify Add Your Opponent Functionality In Team 2 by Invite a Player")
	...
	@Test(priority = 6, description = "Verify Add Your Opponent functionality by selecting the Existing player from the Players List", groups = "sanity")
	@Description("Test case #6, Verify Add Your Opponent functionality by search and select a player from the Players List")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #6, Verify Add Your Opponent functionality by by search and select a player from the Players List")
	...
	@Test(priority = 7, description = "Verify add a game score and submitting added match details", groups = "sanity")
	@Description("Test case #7,Verify add a game score and submitting added match details")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #7, Verify add a game score and submitting added match details")
	...
	@Test(priority = 8, description = "Verify Add a Match functionality Verify add a game score and submitting added match details ", groups = "sanity")
	@Description("Test case #8, Verify Add a Match functionality with Singles & Rally matchas Yes ")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #8, Verify Add a Match functionality with Singles & Rally matchas Yes ")
	...
	@Test(priority = 9, description = "Verify Plus icon functionality for displaying game scrore fields at Add a score page", groups = "sanity")
	@Description("Test case #9,Verify Plus icon functionality for displaying game scrore fields at Add a score page")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #9, Verify Plus icon functionality for displaying game scrore fields at Add a score page")
	...
	@Test(priority = 10, description = "Verify Add score functionality by adding score less than 6 in game 1", groups = "sanity")
	@Description("Test case #10,Verify Add score functionality by adding score less than 6 in game 1")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #10,Verify Add score functionality by adding score less than 6 in game 1")
	...
	@Test(priority = 11, description = "Verify add score functionality by adding game results as both teams won each one game and second game is tie", groups = "sanity")
	@Description("Test case #11,Verify add score functionality by adding game results as both teams won each one game and second game is tie")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #11,Verify add score functionality by adding game results as both teams won each one game and second game is tie")
	...
	@Test(priority = 12, description = "Verify add score functionality by adding game results as both teams won each one game and First game is tie", groups = "sanity")
	@Description("Test case #12,Verify add score functionality by adding game results as both teams won each one game and First game is tie")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #12,Verify add score functionality by adding game results as both teams won each one game and First game is tie")
	...
	@Test(priority = 13, description = "Verify add score functionality with only adding one game scores and leaving other two game score empty", groups = "sanity")
	@Description("Test case #13,Verify add score functionality with only adding one game scores and leaving other two game score empty")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #13, Verify add score functionality with only adding one game scores and leaving other two game score empty")
	...
	@Test(priority = 14, description = "Verify add score functionality with making Tie between Team 1 & Team 2 in all three games", groups = "sanity")
	@Description("Test case #14,Verify add score functionality with making Tie between Team 1 & Team 2 in all three games")
	@Severity(SeverityLevel.NORMAL)
	@Story("Test case #14, Verify add score functionality with making Tie between Team 1 & Team 2 in all three games")
	...
	@Test(priority = 15, description = "Verify player is visible in browse player list After sending invite to palyer ", groups = "sanity")
